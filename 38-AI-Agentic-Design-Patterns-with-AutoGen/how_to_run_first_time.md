## Setup Local Environment for Lab 38 - AI agentic design patterns with autogen

1. **Navigate to the Project Directory**
   - Go inside the `38-AI-Agentic-Design-Patterns-with-AutoGen` folder.
...
6. **Add Environment to Jupyter Kernel**
   - Add the current environment to the Jupyter kernel:
     ```sh
     python3 -m ipykernel install --user --name=38 --display-name "Python (lab 38)"
     ```
...
10. **Select the Correct Kernel**
    - At the top right corner of the Jupyter Notebook, click on the kernel and choose "Python (lab 38)".

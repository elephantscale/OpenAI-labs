## Setup Local Environment for Lab 48-Finetuning Large Language Models

1. **Navigate to the Project Directory**
   - Go inside the `48-Finetuning-Large-Language-Models` folder.
...
6. **Add Environment to Jupyter Kernel**
   - Add the current environment to the Jupyter kernel:
     ```sh
     python3 -m ipykernel install --user --name=48 --display-name "Python (lab 48)"
     ```
...
10. **Select the Correct Kernel**
    - At the top right corner of the Jupyter Notebook, click on the kernel and choose "Python (lab 48)".

## Setup Local Environment for Lab 33 - Prompt compression and query optimization

1. **Navigate to the Project Directory**
   - Go inside the `33-prompt-compression-and-query-optimization` folder.
...
6. **Add Environment to Jupyter Kernel**
   - Add the current environment to the Jupyter kernel:
     ```sh
     python3 -m ipykernel install --user --name=33 --display-name "Python (lab 33)"
     ```
...
10. **Select the Correct Kernel**
    - At the top right corner of the Jupyter Notebook, click on the kernel and choose "Python (lab 33)".

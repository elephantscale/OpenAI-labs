...
def setup_vector_search_index(collection: Collection,
    ...
    if not index_exists:
        try:
            ...
            time.sleep(
                20)  # Sleep for 20 seconds, adding sleep to ensure vector index has compeleted inital sync before utilization
...
def connect_to_database():
    ...
    mongo_client = MongoClient(MONGO_URI, appname="devrel.deeplearning.python", tlsAllowInvalidCertificates=True)

## Setup Local Environment for Lab 46-Improving-Accuracy-of-LLMs

1. **Navigate to the Project Directory**
   - Go inside the `46-Improving-Accuracy-of-LLMs` folder.
...
6. **Add Environment to Jupyter Kernel**
   - Add the current environment to the Jupyter kernel:
     ```sh
     python3 -m ipykernel install --user --name=46 --display-name "Python (lab 46)"
     ```
